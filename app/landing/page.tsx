...
import "@/styles/globals.css" // ensure global styles (including pattern) are loaded
...
export default function LandingPage() {
  return (
    <main className="relative min-h-screen w-full bg-background text-foreground transition-colors duration-200">
      ...
      {/* FEATURES with slanted margins and dotted outer border */}
      <section id="features" className="relative py-24 px-0">
        {/* outer dotted frame, vertical only with sharp corners */}
        <div
          className="pointer-events-none absolute top-10 bottom-10 left-0 w-[5vw] border-l border-dashed border-[rgba(75,85,99,0.3)]"
          aria-hidden="true"
        />
        <div
          className="pointer-events-none absolute top-10 bottom-10 right-0 w-[5vw] border-r border-dashed border-[rgba(75,85,99,0.3)]"
          aria-hidden="true"
        />
        {/* slanted fill inside frame */}
        <div
          className="pointer-events-none absolute top-12 bottom-12 left-0 w-[4vw] bg-[repeating-linear-gradient(-45deg,rgba(148,163,184,0.16)_0,rgba(148,163,184,0.16)_1px,transparent_1px,transparent_7px)] opacity-55"
          aria-hidden="true"
        />
        <div
          className="pointer-events-none absolute top-12 bottom-12 right-0 w-[4vw] bg-[repeating-linear-gradient(-45deg,rgba(148,163,184,0.16)_0,rgba(148,163,184,0.16)_1px,transparent_1px,transparent_7px)] opacity-55"
          aria-hidden="true"
        />

        <div className="relative px-4">
          <div className="max-w-5xl mx-auto space-y-10">
            <div className="border border-border bg-muted/50 dark:bg-black/40 backdrop-blur-sm shadow-[0_0_40px_-12px] shadow-purple-500/20 hover:shadow-[0_0_70px_-10px] hover:shadow-purple-600/40 hover:border-purple-500/30 transition-all duration-500">
              <div className="grid lg:grid-cols-2">
                <div className="p-8 lg:border-r border-border">
                  <h3 className="text-3xl md:text-[2.1rem] font-medium tracking-tight mb-3">
                    Plan, execute, see the trace.
                  </h3>
                  <p className="text-[0.95rem] text-muted-foreground mb-6 leading-relaxed">
                ...
                <div className="p-8 bg-muted/30 dark:bg-background/20">
                  <h4 className="text-xl font-medium mb-4">Custom Building Rules</h4>
                  <p className="text-[0.95rem] text-muted-foreground mb-4 leading-relaxed">
              ...
              <div className="grid md:grid-cols-3 border-t border-border">
                <div className="p-6 md:border-r border-border">
                  <h5 className="text-base font-medium mb-2">Zero Boilerplate</h5>
                  <p className="text-[0.9rem] text-muted-foreground leading-relaxed">Just describe your app idea. netloom handles the rest.</p>
                </div>

                <div className="p-6 md:border-r border-border">
                  <h5 className="text-base font-medium mb-2">Automated Scheduling</h5>
                  <p className="text-[0.9rem] text-muted-foreground leading-relaxed">Set up cron jobs to auto-generate apps every 2 days.</p>
                </div>

                <div className="p-6">
                  <h5 className="text-base font-medium mb-2">Built with Gemini</h5>
                  <p className="text-[0.9rem] text-muted-foreground leading-relaxed">Powered by Google Gemini AI for intelligent code generation.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* HOW IT WORKS + following cards with same framed pattern */}
      <section id="how-it-works" className="relative py-24 px-0">
        ...
        <div className="relative px-4 pb-16">
          <div className="max-w-5xl mx-auto space-y-10">
            ...
            <div className="border border-border bg-muted/50 dark:bg-black/40 backdrop-blur-sm shadow-[0_0_40px_-12px] shadow-purple-500/20 hover:shadow-[0_0_70px_-10px] hover:shadow-purple-600/40 hover:border-purple-500/30 transition-all duration-500">
              <div className="p-8">
                <h3 className="text-3xl md:text-[2.1rem] font-medium tracking-tight mb-4">
        ...
        {/* horizontal dotted separator aligned with bottom of side frames */}
      </section>

      {/* CTA section remains without pattern */}
      <section className="relative py-24 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="border border-border bg-muted/50 dark:bg-black/40 backdrop-blur-sm p-12 shadow-[0_0_40px_-12px] shadow-purple-500/20 text-center rounded-3xl">
            <h3 className="text-3xl md:text-[2.1rem] font-medium tracking-tight mb-4">
            ...
            <Link
              href="/"
              className="inline-block px-7 py-2.5 bg-purple-600 hover:bg-purple-700 text-white text-sm font-medium transition-colors shadow-lg shadow-purple-500/20 rounded-xl"
            >
              Start Building Now
            </Link>
          </div>
