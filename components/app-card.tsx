...
export function AppCard({ app, onDelete }: { app: any; onDelete?: (id: string) => void }) {
  ...
  return (
    <div className="border border-border rounded-lg p-4 bg-background/60 hover:border-foreground/20 transition-colors space-y-3">
      ...
      {app.app_code && (
        <div className="mt-4 space-y-2">
          ...
          <WebcontainerPreview 
            appName={app.app_name ?? "Generated App"} 
            code={app.app_code}
            appId={app.id}
          />
        </div>
